...
"""Fixed-route energy sensitivity under the stated transport energy model.

AI assistance: This program and its code were prepared with OpenAI Codex
(GPT-6, OpenAI; GPT-6 family release 2026-09-03). The team must review it.
"""
