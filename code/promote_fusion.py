...
"""Replay the archived rescue-time choice and verify it before submission export.

The stochastic method comparison documents discovery.  The archived selected
plans make the final tables exactly reproducible without relying on wall-clock
search returning the same incumbent on another machine.
"""
import json
import shutil
from common import Model, RESULT, save
from solve_transport import metrics
from partition_validate import partition, validate
from communication import certify_routes
