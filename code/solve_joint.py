...
"""Generate Q3 from Q2 routes, then search relay sites and coordinated schedules."""
from common import *
from itertools import product
from solve_transport import improve_schedule, metrics
from communication import gateway, relay_flight, sample_segments, select_relays, certify_routes
...
def direct_relief_candidates(m,routes,data):
    """Try a direct trip for each soft-late box while retaining its other cargo."""
    candidates=[]
