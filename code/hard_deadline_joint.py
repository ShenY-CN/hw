"""Select transport models and departure times under every box's hard due time.

The search only proposes schedules. A candidate is accepted after the independent
route, resource, and continuous communication validators all pass.
"""
import argparse
import json
import math
...
from common import Model, RESULT, charge, save
from communication import certify_routes
from joint_schedule import allowed_starts, intersect
